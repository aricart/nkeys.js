...
System.register("deps/deps", [], function (exports_26, context_26) {
  "use strict";
  var System,
    __instantiate,
    __exp,
    ...
    execute: function () {
      (() => {
        ...
        async function dI(mid, src) {
          ...
          return r.has(id) ? gExpA(id) : context_26.import(mid);
        }
        function gC(id, main) {
          return {
            id,
      ...
      System.register(
        "https://deno.land/x/tweetnacl_deno/src/array",
        [],
        function (exports_1, context_1) {
          ...
          exports_1("HalfArray", HalfArray);
          function WordArray(n) {
            return new Uint32Array(n);
          }
          exports_1("WordArray", WordArray);
          function IntArray(n) {
            return new Int32Array(n);
          }
          exports_1("IntArray", IntArray);
          function NumArray(n) {
            return new Float64Array(n);
          }
          exports_1("NumArray", NumArray);
          return {
            setters: [],
            execute: function () {
            },
      ...
      System.register(
        "https://deno.land/x/tweetnacl_deno/src/validate",
        [],
        function (exports_2, context_2) {
          ...
          exports_2("validateBase64", validateBase64);
          function validateHex(s) {
            if (!/^(?:[A-Fa-f0-9]{2})+$/.test(s)) {
              throw new TypeError("invalid hex string");
            }
          }
          exports_2("validateHex", validateHex);
          return {
            setters: [],
            execute: function () {
            },
      ...
      System.register(
        "https://raw.githubusercontent.com/chiefbiiko/base64/master/base",
        [],
      ...
      System.register(
        "https://raw.githubusercontent.com/chiefbiiko/base64/master/mod",
        ["https://raw.githubusercontent.com/chiefbiiko/base64/master/base"],
        function (exports_4, context_4) {
          ...
          return {
            ...
            execute: function () {
              ...
              exports_4("byteLength", byteLength = mod.byteLength);
              exports_4("toUint8Array", toUint8Array = mod.toUint8Array);
              exports_4("fromUint8Array", fromUint8Array = mod.fromUint8Array);
            },
          };
        },
      );
      System.register(
        "https://deno.land/std@0.52.0/encoding/hex",
        [],
      ...
      System.register("https://deno.land/x/tweetnacl_deno/src/server/convert", [
        "https://deno.land/x/tweetnacl_deno/src/validate",
        "https://raw.githubusercontent.com/chiefbiiko/base64/master/mod",
        "https://deno.land/std@0.52.0/encoding/hex",
      ...
      System.register(
        "https://deno.land/x/tweetnacl_deno/src/convert",
        ["https://deno.land/x/tweetnacl_deno/src/server/convert"],
      ...
      System.register(
        "https://deno.land/x/tweetnacl_deno/src/salsa20",
        ["https://deno.land/x/tweetnacl_deno/src/array"],
        function (exports_8, context_8) {
          ...
          function _salsa20(o, p, k, c) {
            const j0 = c[0] & 0xff | (c[1] & 0xff) << 8 | (c[2] & 0xff) << 16 |
                (c[3] & 0xff) << 24,
              j1 = k[0] & 0xff | (k[1] & 0xff) << 8 | (k[2] & 0xff) << 16 |
                (k[3] & 0xff) << 24,
              j2 = k[4] & 0xff | (k[5] & 0xff) << 8 | (k[6] & 0xff) << 16 |
                (k[7] & 0xff) << 24,
              j3 = k[8] & 0xff | (k[9] & 0xff) << 8 | (k[10] & 0xff) << 16 |
                (k[11] & 0xff) << 24,
              j4 = k[12] & 0xff | (k[13] & 0xff) << 8 | (k[14] & 0xff) << 16 |
                (k[15] & 0xff) << 24,
              j5 = c[4] & 0xff | (c[5] & 0xff) << 8 | (c[6] & 0xff) << 16 |
                (c[7] & 0xff) << 24,
              j6 = p[0] & 0xff | (p[1] & 0xff) << 8 | (p[2] & 0xff) << 16 |
                (p[3] & 0xff) << 24,
              j7 = p[4] & 0xff | (p[5] & 0xff) << 8 | (p[6] & 0xff) << 16 |
                (p[7] & 0xff) << 24,
              j8 = p[8] & 0xff | (p[9] & 0xff) << 8 | (p[10] & 0xff) << 16 |
                (p[11] & 0xff) << 24,
              j9 = p[12] & 0xff | (p[13] & 0xff) << 8 | (p[14] & 0xff) << 16 |
                (p[15] & 0xff) << 24,
              j10 = c[8] & 0xff | (c[9] & 0xff) << 8 | (c[10] & 0xff) << 16 |
                (c[11] & 0xff) << 24,
              j11 = k[16] & 0xff | (k[17] & 0xff) << 8 | (k[18] & 0xff) << 16 |
                (k[19] & 0xff) << 24,
              j12 = k[20] & 0xff | (k[21] & 0xff) << 8 | (k[22] & 0xff) << 16 |
                (k[23] & 0xff) << 24,
              j13 = k[24] & 0xff | (k[25] & 0xff) << 8 | (k[26] & 0xff) << 16 |
                (k[27] & 0xff) << 24,
              j14 = k[28] & 0xff | (k[29] & 0xff) << 8 | (k[30] & 0xff) << 16 |
                (k[31] & 0xff) << 24,
              j15 = c[12] & 0xff | (c[13] & 0xff) << 8 | (c[14] & 0xff) << 16 |
                (c[15] & 0xff) << 24;
            let x0 = j0,
              x1 = j1,
              x2 = j2,
          ...
          exports_8("_stream_xor", _stream_xor);
          return {
            setters: [
      ...
      System.register(
        "https://deno.land/x/tweetnacl_deno/src/poly1305",
        ["https://deno.land/x/tweetnacl_deno/src/array"],
        function (exports_9, context_9) {
          ...
          exports_9("poly1305_init", poly1305_init);
          ...
          exports_9("poly1305_blocks", poly1305_blocks);
          ...
          exports_9("poly1305_finish", poly1305_finish);
          ...
          exports_9("poly1305_update", poly1305_update);
          return {
            setters: [
      ...
      System.register("https://deno.land/x/tweetnacl_deno/src/secretbox", [
        "https://deno.land/x/tweetnacl_deno/src/array",
        "https://deno.land/x/tweetnacl_deno/src/verify",
        "https://deno.land/x/tweetnacl_deno/src/salsa20",
        "https://deno.land/x/tweetnacl_deno/src/poly1305",
        "https://deno.land/x/tweetnacl_deno/src/check",
        ...
        exports_10("secretbox", secretbox);
        function secretbox_open(box, nonce, key) {
          ...
          if (
            c.length < 32 || _secretbox_open(m, c, c.length, nonce, key) !== 0
          ) {
            return;
          }
          return m.subarray(32);
        }
        exports_10("secretbox_open", secretbox_open);
        ...
        exports_10("_onetimeauth", _onetimeauth);
      ...
      System.register(
        "https://deno.land/x/tweetnacl_deno/src/core",
        ["https://deno.land/x/tweetnacl_deno/src/array"],
        function (exports_11, context_11) {
          ...
          return {
            ...
            execute: function () {
              exports_11("_0", _0 = array_ts_4.ByteArray(16));
              exports_11("_9", _9 = array_ts_4.ByteArray(32));
              _9[0] = 9;
              exports_11("gf0", gf0 = gf());
              exports_11("gf1", gf1 = gf([1]));
              exports_11("_121665", _121665 = gf([0xdb41, 1]));
              exports_11(
                "D",
                D = gf([
                  0x78a3,
      ...
      System.register(
        "https://deno.land/x/tweetnacl_deno/src/random",
        ["https://deno.land/x/tweetnacl_deno/src/array"],
      ...
      System.register("https://deno.land/x/tweetnacl_deno/src/curve25519", [
        "https://deno.land/x/tweetnacl_deno/src/array",
        "https://deno.land/x/tweetnacl_deno/src/verify",
        "https://deno.land/x/tweetnacl_deno/src/core",
        ...
        exports_13("pack25519", pack25519);
        ...
        exports_13("neq25519", neq25519);
        function par25519(a) {
          const d = array_ts_6.ByteArray(32);
          pack25519(d, a);
          return d[0] & 1;
        }
        exports_13("par25519", par25519);
        ...
        exports_13("unpack25519", unpack25519);
      ...
      System.register("https://deno.land/x/tweetnacl_deno/src/scalarmult", [
        "https://deno.land/x/tweetnacl_deno/src/array",
        "https://deno.land/x/tweetnacl_deno/src/core",
        "https://deno.land/x/tweetnacl_deno/src/curve25519",
        "https://deno.land/x/tweetnacl_deno/src/check",
        ...
        exports_14("scalarMult", scalarMult);
        ...
        exports_14("scalarMult_base", scalarMult_base);
        ...
        exports_14("_scalarMult", _scalarMult);
        function _scalarMult_base(q, n) {
          return _scalarMult(q, n, core_ts_2._9);
        }
        exports_14("_scalarMult_base", _scalarMult_base);
        return {
          setters: [
      ...
      System.register("https://deno.land/x/tweetnacl_deno/src/box", [
        "https://deno.land/x/tweetnacl_deno/src/array",
        "https://deno.land/x/tweetnacl_deno/src/core",
        "https://deno.land/x/tweetnacl_deno/src/random",
        "https://deno.land/x/tweetnacl_deno/src/salsa20",
        "https://deno.land/x/tweetnacl_deno/src/scalarmult",
        "https://deno.land/x/tweetnacl_deno/src/secretbox",
        "https://deno.land/x/tweetnacl_deno/src/check",
        ...
        exports_15("box_keyPair_fromSecretKey", box_keyPair_fromSecretKey);
        ...
        return {
          ...
          execute: function () {
            exports_15("box_after", box_after = secretbox_ts_1.secretbox);
            exports_15(
              "box_open_after",
              box_open_after = secretbox_ts_1.secretbox_open,
            );
          },
        };
      });
      System.register(
        ...
        function (exports_16, context_16) {
          ...
          exports_16("checkLengths", checkLengths);
          ...
          exports_16("checkBoxLengths", checkBoxLengths);
          ...
          exports_16("checkArrayTypes", checkArrayTypes);
          return {
            setters: [],
            execute: function () {
            },
      ...
      System.register(
        ...
        function (exports_17, context_17) {
          ...
          exports_17("_verify_16", _verify_16);
          function _verify_32(x, xi, y, yi) {
            return vn(x, xi, y, yi, 32);
          }
          exports_17("_verify_32", _verify_32);
          function verify(x, y) {
      ...
      System.register("https://deno.land/x/tweetnacl_deno/src/hash", [
        "https://deno.land/x/tweetnacl_deno/src/array",
        "https://deno.land/x/tweetnacl_deno/src/check",
        ...
        exports_18("hash", hash);
        function _hash(out, m, n) {
          const hh = array_ts_9.IntArray(8),
            hl = array_ts_9.IntArray(8),
            x = array_ts_9.ByteArray(256);
          let i, b = n;
          hh[0] = 0x6a09e667;
          hh[1] = 0xbb67ae85;
          hh[2] = 0x3c6ef372;
      ...
      System.register("https://deno.land/x/tweetnacl_deno/src/sign", [
        "https://deno.land/x/tweetnacl_deno/src/array",
        "https://deno.land/x/tweetnacl_deno/src/verify",
        "https://deno.land/x/tweetnacl_deno/src/core",
        "https://deno.land/x/tweetnacl_deno/src/random",
        "https://deno.land/x/tweetnacl_deno/src/curve25519",
        "https://deno.land/x/tweetnacl_deno/src/hash",
        "https://deno.land/x/tweetnacl_deno/src/check",
        ...
        exports_19("sign_open", sign_open);
        ...
        exports_19("sign_detached", sign_detached);
        ...
        exports_19("sign_detached_verify", sign_detached_verify);
        ...
        exports_19("sign_keyPair", sign_keyPair);
        ...
        exports_19("sign_keyPair_fromSecretKey", sign_keyPair_fromSecretKey);
        ...
        exports_19("sign_keyPair_fromSeed", sign_keyPair_fromSeed);
        ...
        function _sign(sm, m, n, sk) {
          const d = array_ts_10.ByteArray(64),
            h = array_ts_10.ByteArray(64),
            r = array_ts_10.ByteArray(64);
        ...
        exports_19("scalarbase", scalarbase);
        ...
        exports_19("scalarmult", scalarmult);
        function pack(r, p) {
      ...
      System.register("https://deno.land/x/tweetnacl_deno/src/auth", [
        "https://deno.land/x/tweetnacl_deno/src/array",
        "https://deno.land/x/tweetnacl_deno/src/hash",
        ...
        exports_20("auth", auth);
        function hmac(msg, key) {
          const buf = array_ts_11.ByteArray(
            BLOCK_SIZE + Math.max(HASH_SIZE, msg.length),
          );
          let i, innerHash;
        ...
        return {
          ...
          execute: function () {
            BLOCK_SIZE = 128;
            HASH_SIZE = 64;
            exports_20("auth_full", auth_full = hmac);
          },
        };
      });
      System.register(
        "https://deno.land/x/tweetnacl_deno/src/blake2s",
        ["https://deno.land/x/tweetnacl_deno/src/array"],
        function (exports_21, context_21) {
          ...
          exports_21("blake2s_init", blake2s_init);
          ...
          exports_21("blake2s_update", blake2s_update);
          ...
          exports_21("blake2s_final", blake2s_final);
      ...
      System.register(
        "https://deno.land/x/tweetnacl_deno/src/blake2b",
        ["https://deno.land/x/tweetnacl_deno/src/array"],
        function (exports_22, context_22) {
          ...
          exports_22("blake2b_init", blake2b_init);
          ...
          exports_22("blake2b_update", blake2b_update);
          ...
          exports_22("blake2b_final", blake2b_final);
      ...
      System.register("https://deno.land/x/tweetnacl_deno/src/sealedbox", [
        "https://deno.land/x/tweetnacl_deno/src/array",
        "https://deno.land/x/tweetnacl_deno/src/box",
        "https://deno.land/x/tweetnacl_deno/src/blake2b",
        ...
        exports_23("sealedbox", sealedbox);
        ...
        exports_23("sealedbox_open", sealedbox_open);
      ...
      System.register("https://deno.land/x/tweetnacl_deno/src/nacl", [
        "https://deno.land/x/tweetnacl_deno/src/array",
        "https://deno.land/x/tweetnacl_deno/src/validate",
        "https://deno.land/x/tweetnacl_deno/src/convert",
        "https://deno.land/x/tweetnacl_deno/src/verify",
        ...
        "https://deno.land/x/tweetnacl_deno/src/secretbox",
        "https://deno.land/x/tweetnacl_deno/src/box",
        "https://deno.land/x/tweetnacl_deno/src/sign",
        "https://deno.land/x/tweetnacl_deno/src/hash",
        "https://deno.land/x/tweetnacl_deno/src/auth",
        "https://deno.land/x/tweetnacl_deno/src/blake2s",
        "https://deno.land/x/tweetnacl_deno/src/blake2b",
        "https://deno.land/x/tweetnacl_deno/src/sealedbox",
      ...
      System.register(
        "file:///Users/synadia/Dropbox/code/src/github.com/aricart/nkeys.js/deps/mod",
        ["https://deno.land/x/tweetnacl_deno/src/nacl"],
          ...
          return {
            setters: [
              function (nacl_ts_1_1) {
                exports_25({
                  "sign_keyPair_fromSeed": nacl_ts_1_1["sign_keyPair_fromSeed"],
                  "sign_detached": nacl_ts_1_1["sign_detached"],
                  "sign_detached_verify": nacl_ts_1_1["sign_detached_verify"],
                  "randomBytes": nacl_ts_1_1["randomBytes"],
                });
              },
            ],
            execute: function () {
      ...
      exports_26(
        "sign_keyPair_fromSeed",
        sign_keyPair_fromSeed = __exp["sign_keyPair_fromSeed"],
      );
      exports_26("sign_detached", sign_detached = __exp["sign_detached"]);
      exports_26(
        "sign_detached_verify",
        sign_detached_verify = __exp["sign_detached_verify"],
      );
      exports_26("randomBytes", randomBytes = __exp["randomBytes"]);
    },
  };
});
System.register("src/crc16", [], function (exports_1, context_1) {
  "use strict";
  var crc16tab, crc16;
  var __moduleName = context_1 && context_1.id;
  return {
...
System.register("src/base32", [], function (exports_2, context_2) {
  "use strict";
  var base32;
  var __moduleName = context_2 && context_2.id;
  return {
...
System.register(
  "src/codec",
  ["src/crc16", "src/nkeys", "src/base32"],
  function (exports_3, context_3) {
    "use strict";
        ...
        Codec = class Codec {
          static encode(prefix, src) {
            if (!src || !(src instanceof Uint8Array)) {
              throw new nkeys_ts_1.NKeysError(
                nkeys_ts_1.NKeysErrorCode.SerializationError,
              );
            }
            if (!nkeys_ts_1.Prefixes.isValidPrefix(prefix)) {
              throw new nkeys_ts_1.NKeysError(
                nkeys_ts_1.NKeysErrorCode.InvalidPrefixByte,
              );
            }
          ...
          static encodeSeed(role, src) {
            if (!src) {
              throw new nkeys_ts_1.NKeysError(
                nkeys_ts_1.NKeysErrorCode.ApiError,
              );
            }
            ...
            if (src.byteLength !== 32) {
              throw new nkeys_ts_1.NKeysError(
                nkeys_ts_1.NKeysErrorCode.InvalidSeedLen,
              );
            }
          ...
          static decodeSeed(src) {
            ...
            if (prefix[0] != nkeys_ts_1.Prefix.Seed) {
              throw new nkeys_ts_1.NKeysError(
                nkeys_ts_1.NKeysErrorCode.InvalidSeed,
              );
            }
          ...
          static _encode(seed, role, payload) {
            ...
            if (seed) {
              const encodedPrefix = Codec._encodePrefix(
                nkeys_ts_1.Prefix.Seed,
                role,
              );
            ...
            const checksum = crc16_ts_1.crc16.checksum(
              raw.slice(0, checkOffset),
            );
          ...
          static _decode(src) {
            if (src.byteLength < 4) {
              throw new nkeys_ts_1.NKeysError(
                nkeys_ts_1.NKeysErrorCode.InvalidEncoding,
              );
            }
            let raw;
            try {
            ...
            if (!crc16_ts_1.crc16.validate(payload, checksum)) {
              throw new nkeys_ts_1.NKeysError(
                nkeys_ts_1.NKeysErrorCode.InvalidChecksum,
              );
            }
            return payload;
          }
...
System.register(
  "src/kp",
  ["deps/deps", "src/codec", "src/nkeys"],
  function (exports_4, context_4) {
    "use strict";
    var deps_js_1, codec_ts_1, nkeys_ts_2, KP;
    var __moduleName = context_4 && context_4.id;
    return {
      setters: [
      ...
      execute: function () {
        KP = class KP {
          ...
          getPublicKey() {
            ...
            const kp = deps_js_1.sign_keyPair_fromSeed(this.getRawSeed());
            const buf = codec_ts_1.Codec.encode(sd.prefix, kp.publicKey);
            return new TextDecoder().decode(buf);
          }
          getPrivateKey() {
            const kp = deps_js_1.sign_keyPair_fromSeed(this.getRawSeed());
            return codec_ts_1.Codec.encode(
              nkeys_ts_2.Prefix.Private,
              kp.secretKey,
            );
          }
          sign(input) {
            const kp = deps_js_1.sign_keyPair_fromSeed(this.getRawSeed());
            return deps_js_1.sign_detached(input, kp.secretKey);
          }
          verify(input, sig) {
            const kp = deps_js_1.sign_keyPair_fromSeed(this.getRawSeed());
            return deps_js_1.sign_detached_verify(input, sig, kp.publicKey);
          }
        };
        exports_4("KP", KP);
      },
...
System.register(
  ...
  function (exports_5, context_5) {
    "use strict";
    var deps_js_2, codec_ts_2, nkeys_ts_3, PublicKey;
    var __moduleName = context_5 && context_5.id;
    return {
      setters: [
      ...
      execute: function () {
        PublicKey = class PublicKey {
          ...
          getPrivateKey() {
            throw new nkeys_ts_3.NKeysError(
              nkeys_ts_3.NKeysErrorCode.PublicKeyOnly,
            );
          }
          getSeed() {
            throw new nkeys_ts_3.NKeysError(
          ...
          sign(_) {
            throw new nkeys_ts_3.NKeysError(
              nkeys_ts_3.NKeysErrorCode.CannotSign,
            );
          }
          verify(input, sig) {
            let buf = codec_ts_2.Codec._decode(this.publicKey);
            return deps_js_2.sign_detached_verify(input, sig, buf.slice(1));
          }
        };
...
System.register(
  "src/nkeys",
  ["deps/deps", "src/kp", "src/public", "src/codec"],
  function (exports_6, context_6) {
    "use strict";
    var deps_js_3,
      kp_ts_1,
    ...
    function createPair(prefix) {
      const rawSeed = deps_js_3.randomBytes(32);
    ...
    return {
      setters: [
        function (deps_js_3_1) {
          deps_js_3 = deps_js_3_1;
        },
        function (kp_ts_1_1) {
          kp_ts_1 = kp_ts_1_1;
        },
      ...
      execute: function () {
        ...
        (function (NKeysErrorCode) {
          ...
          NKeysErrorCode["InvalidSignature"] =
...
System.register("src/mod", ["src/nkeys"], function (exports_7, context_7) {
  "use strict";
  var __moduleName = context_7 && context_7.id;
  return {
    setters: [
...
const __exp = __instantiate("src/mod", false);
