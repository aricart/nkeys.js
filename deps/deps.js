  ...
  function (exports_19, context_19) {
    ...
    function _sign_open(m, sm, n, pk) {
      ...
      const p = [
        ...
        q = [core_ts_4.gf(), core_ts_4.gf(), core_ts_4.gf(), core_ts_4.gf()];
      let i, mlen;
      mlen = -1;
...
export const sign_keyPair_fromSeed = __exp["sign_keyPair_fromSeed"];
export const sign_detached = __exp["sign_detached"];
export const sign_detached_verify = __exp["sign_detached_verify"];
export const randomBytes = __exp["randomBytes"];
